 ...
 *
 * Note: Telepen support is handled at the Html5QrcodeShim level,
 * not here, to ensure it's tried on every frame regardless of
 * which decoder is selected by the alternating logic.
 */
